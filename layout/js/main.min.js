...
function contactJSON() {
  $.getJSON('contact.json', function (contact) {
    for (c = 0; c < contact.length; c++) {
      $('.contacts').append(
        `<a href="${contact[c].link}" target="_blank"><img src="img/icons/${contact[c].img}.svg" alt="${contact[c].img}" width="35" height="35"/></a>`,
      );
    }
  });
}
        ...
        `<div class="testimonial">
          <div class="profile"> 
            <div class="image"> 
              ...
              }" alt="${testi[t].clientName}" loading="lazy">
            </div>
            <div class="text"> 
          ...
          <div class="testi">
            ...
            <img src="img/icons/five_stars.webp" alt="fiveStars" width="110" height="22">
          </div>
        </div>`,
      );
    }
